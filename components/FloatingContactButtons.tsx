        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              aria-label={dictionary.floating.closeAria}
            >
              ×
            </button>
          </div>
